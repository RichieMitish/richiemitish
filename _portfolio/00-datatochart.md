...
<div align=center>
    <img src="/assets/images/wemail.png">
</div>
<br>
...
<div class="thumb-full" align="center">
    <a href="#00_intstart">
...
<!--To not miss out this step still, please see this video showing you the Integration creation and set up process. No big deal, you simply select the options you need, but we felt like filling this little gap.
VIDEO-->
...
<!--And same here, the demo Integration is "connected" already, but here's a video showing you the process with the Google AdWords account as an example.
VIDEO-->
